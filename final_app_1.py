...
def get_coordinates(data):
	GPGGA_data_available= data.find(gpgga_info)
	if (GPGGA_data_available > 0):
		GPGGA_buffer = data.split("$GPGGA, ",1)[1]
...
start_position = get_coordinates(str)(ser.readline())

try:
	while True:
		data = (str)(ser.readline())
		position = get_coordinates(data)
		if (position != start_position):
			writer_2.writerow(position)
			print("NMEA Latitude:", position[0], "NMEA Longitude", position[1], '\n')
